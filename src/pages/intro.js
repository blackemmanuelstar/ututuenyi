import orji from "../Images/ORJI.jpeg";
import groupPic from "../Images/friendship.jpg";
    ...
    <>
      ...
      <div className="intro">
        <p className="welcome-message">
          ...
          <br />
          In so doing, we can stand in for one and another as the saying goes
          “one for all and all for one”.
          <br />
          Therefore, may I encourage you to prepare your minds and be ready to
          contribute your time, energy, and resources for the course of
          Nkisi-Ena League of Friends. <br />
          By the grace of Almighty God, we will make an impact and set
          precedence for others to follow.
          <br /> Long live Nkisi-Ena and long live Abiriba Enachioken.
          <br />
        </p>
        <div className="intro-speaker">
          <img src={orji} className="orji" />
          <p className="tag">
      ...
      <div className="after-intro">
        <img src={groupPic} className="group-pic" />
      </div>
      <Footer />
    </>
  );
